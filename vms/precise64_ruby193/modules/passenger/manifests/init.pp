class passenger {
  ...
  exec {
    "/usr/local/bin/gem install passenger -v=3.0.15":
      ...
      unless  => "ls /usr/local/lib/ruby/gems/1.9.1/gems/passenger-3.0.15/"
  }
  ...
  "/usr/local/bin/passenger-install-apache2-module --auto":
    ...
    unless  => "ls /usr/local/lib/ruby/gems/1.9.1/gems/passenger-3.0.15/ext/apache2/mod_passenger.so"
  }
